<!--<form class="form" id="kt_form_datos_proyecto">-->
  ...
  <div class="form-group">
     <h3 class="mb-10 font-weight-bold text-dark">Descripción de daños</h3>
  </div>
  <div class="row">
     <div class="col-xl-12">
       <div class="form-group">
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="500" name="descripcion_danos" id="descripcion_danos" value="{{$proyecto->descripcion_danos}}">
          <span class="form-text text-muted">Este campo es obligatorio.</span>
       </div>
     </div>
  </div>
