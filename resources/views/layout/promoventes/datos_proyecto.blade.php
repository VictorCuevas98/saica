<!--<form class="form" id="kt_form_datos_proyecto">-->
  ...
  <div class="row">
     <div class="col-xl-6">
       ...
       <div class="form-group">
          ...
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="400" name="nombre_proyecto" id="nombre_proyecto">
     ...
     <div class="col-xl-6">
        ...
        <!--<div class="form-group">
           ...
           <select name="id_programa" id="id_programa" class="form-control form-control-solid form-control-lg">
              <option value="">Selecciona</option>
              <option value="AF">Programa Especial de Regeneración Urbana y Vivienda Incluyente (PRUVI) 2019-2024 para la Ciudad de México</option>
              <option value="AX">Norma para Impulsar y Facilitar la Construcción de Vivienda para los Trabajadores Derechohabientes de los Organismos Nacionales de Vivienda en Suelo Urbano</option>
              <option value="AX">La Norma de Ordenación Número 26.</option>
           </select>
           <span class="form-text text-muted">Este campo es obligatorio.</span>
        </div>-->
        <!--end::Input-->
        ...
        <div class="col-12 col-form-label">
            <div class="checkbox-list">
                ...
                <label class="checkbox">
                    <input type="checkbox"  name="id_programa[]" value="3"/>
                    <span></span>
  ...
  <div class="row">
     <div class="col-xl-4">
        ...
        <div class="form-group">
           ...
           <input type="text" class="form-control form-control-solid form-control-lg" maxlength="6" name="cpostal_proyecto" id="cpostal_proyecto" onchange="buscar_cp_proyecto();">
           <span class="form-text text-muted">Este campo es obligatorio.</span>
        </div>
        <!--end::Input-->
     </div>
  ...
  <div class="row">
     <div class="col-xl-6">
       ...
       <div class="form-group">
          <label>Calle</label>
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="400" name="calle_proyecto" id="calle_proyecto">
          <span class="form-text text-muted">Este campo es obligatorio.</span>
       </div>
       <!--end::Input-->
     </div>
     <div class="col-xl-3">
       ...
       <div class="form-group">
          ...
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="100" name="nexterior_proyecto" id="nexterior_proyecto">
          <span class="form-text text-muted">Este campo es obligatorio.</span>
       </div>
       <!--end::Input-->
     </div>
     <div class="col-xl-3">
       ...
       <div class="form-group">
          ...
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="100" name="ninterior_proyecto" id="ninterior_proyecto">
       </div>
       <!--end::Input-->
     </div>
  </div>
  <div class="row">
     <div class="col-xl-4">
       ...
       <div class="form-group">
          ...
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="12" name="cuenta_catastral" id="cuenta_catastral">
     ...
     <div class="col-xl-4">
       ...
       <div class="form-group">
          ...
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="16" name="cuenta_agua" id="cuenta_agua">
  ...
  <div class="row">
     <div class="col-xl-12">
       <div class="form-group">
          <input type="text" class="form-control form-control-solid form-control-lg" maxlength="400" name="descripcion" id="descripcion">
          <span class="form-text text-muted">Este campo es obligatorio.</span>
       </div>
     </div>
  </div>
