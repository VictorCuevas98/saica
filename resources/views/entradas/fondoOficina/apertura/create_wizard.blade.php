                                        ...
                                        <div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first" data-wizard-clickable="false">
                                                ...
                                                <div class="wizard-steps p-8 p-lg-10">
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="step">
                                                        <div class="wizard-label">
                                                            ...
                                                            <h3 class="wizard-title">3. Revisar y enviar</h3>
                                                        </div>
                                            ...
                                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                                <div class="col-xl-12 col-xxl-7">
                                                    <!--begin::Wizard Form-->
                                                    <form class="form" id="kt_form" action="{{route('entradas.fondoOficinas.store')}}" method="POST">
                                                        @method('POST')
                                                        @csrf
                                                        <!--begin::Wizard Step 1-->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="oficio_de_adjudicacion" placeholder="" value="" id="oficio_de_adjudicacion"/>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="numero_de_requisicion" placeholder="" value="" />
                                                                        <span class="form-text text-muted"></span>
                                                                    </div>
                                                                    <!--end::Input-->
                                                                </div>
                                                        ...
                                                        <div class="pb-5" data-wizard-type="step-content">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-solid">
                                                                    <input type="text" class="form-control form-control-lg" aria-label="botón para buscar el rfc en el padrón de proveedores" name="rfc_del_proveedor" id="rfc_del_proveedor" value="CSI130326HD1" id=""/>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="razon_social_del_proveedor" id="razon_social_del_proveedor" placeholder="" value="" disabled />
                                                                        <span class="form-text text-muted"></span>
                                                                    </div>
                                                                    <!--end::Input-->
                                                                </div>
                                                            ...
                                                            <div class="row persona_fisica_content"  style="display: none;">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Nombres</label>
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="nombres" placeholder="" id="nombres" value="" disabled />
                                                                        <span class="form-text text-muted"></span>
                                                                    </div>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="primer_apellido" id="primer_apellido" placeholder="" value="" disabled/>
                                                                        <span class="form-text text-muted"></span>
                                                                    </div>
                                                                    <!--end::Input-->
                                                                </div>
                                                            ...
                                                            <div class="row persona_fisica_content" style="display: none;">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="segundo_apellido" id="segundo_apellido" placeholder="" value="" disabled />
                                                                        <span class="form-text text-muted"></span>
                                                                    </div>
                                                                    <!--end::Input-->
                                                                </div>
                    ...
                    if(typeof(res.data) =='undefined'){
                        ...
                        switch (res.data.tipo_persona.toLowerCase()) {
                          case 'fisica':
                            ...
                            break;
                          case 'moral':
                            console.log('res.dataLegal.data',res.dataLegal.data);
                            //console.log(res.data.tipo_persona.toLowerCase());
                            $('#razon_social_del_proveedor').val(res.data.razon_social);
                            $('#nombres').val('--');
                            $('#primer_apellido').val('--');
                            $('#segundo_apellido').val('--');
                            $("#representante_del_proveedor").val(res.dataLegal.data.nombre +' '+res.dataLegal.data.paterno +' '+ res.dataLegal.data.materno);
                            $('#tipo_de_persona option[value=F]').prop('selected',null);
                    ...
                    _formEl,
                    {
                        fields: {
                            ...
                            numero_de_requisicion: {
                                validators: {
                                    remote: {
                                        message: 'Ya existe un proceso de adquisición con este número de requisición',
                                        //method: 'GET',
                                        delay: 1000,
                                        type: 'GET',
