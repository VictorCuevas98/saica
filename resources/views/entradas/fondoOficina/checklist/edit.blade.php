    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm mr-5">
                ...
                <li class="breadcrumb-item text-muted">
                    <span class="text-muted">{{$entrada->folio_entrada}}</span>
                </li>
                                        ...
                                        <div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first" data-wizard-clickable="false">
                                            ...
                                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                                <div class="col-xl-12 col-xxl-7">
                                                    <!--begin::Wizard Form-->
                                                    <form class="form" id="kt_form" action="{{route('entradas.fondoOficinas.checklist.update',[$adquisicionId, $entradaId])}}"  method="POST">
                                                        @method('PUT')
                                                        @csrf
                                                        <!--begin::Wizard Step 1-->
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="almacen" class="form-control form-control-solid form-control-lg"  id="ingreso_almacen">
                                                                            ...
                                                                            @foreach($almacenes as $almacen)
                                                                                @php
                                                                                    $almacenSelected = ($almacen->clave_almacen == $entrada->almacen->clave_almacen) ? 'selected' : '';
                                                                                @endphp
                                                                                <option value="{{$almacen->clave_almacen}}" {{$almacenSelected}} >{{$almacen->almacen}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                    <!--end::Select-->
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" class="form-control form-control-solid form-control-lg" name="fecha_de_entrada" id="fecha_de_entrada" placeholder="" value="{{$entrada->fecha_entrada}}"  />
                                                        ...
                                                        <div class="pb-5" data-wizard-type="step-content">
                                                            ...
                                                            <div class="form-group row">
                                                                @php
                                                                    $estatus = $entrada->entradaAdquisicion->entradasAdquisicionRevisionStatus()->activos()->get()->first()->catStatus->clave_status_revision_entrada ;
                                                                @endphp        
                                                                <label  class="col-sm-12 col-md-2 col-lg-2 col-xl-1 col-form-label">Folio</label>
                                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-3">
                                                                 <input class="form-control" type="text" id="example-text-input" name="folio_de_revision" required=""value="{{$entrada->folio_entrada}}"  />
                                                                </div>
                                                                  ...
                                                                  <div class="col-3">
                                                                   <span class="switch switch-xl switch-icon">
                                                                    <label>
                                                                     ...
                                                                     <input type="checkbox"  name="aprobada" {{ ($estatus=='A' || $estatus=='AO') ? 'checked' : '' }} />
                                                                     <span></span>
                                                                    </label>
                                                                   </span>
                                                                  </div>
                                                                   ...
                                                                   <table class="table  ">
                                                                        <tbody>
                                                                            @php
                                                                                ...
                                                                                ->whereHas('pregunta', function ($query) use($tipoRevision){
                                                                                    $query->where('id_tipo_revision', $tipoRevision->id);
                                                                                })->orderBy('id')->get();
                                                                            @endphp
                                                                            ...
                                                                            <tr>
                                                                                <td class="">
                                                                                    ...
                                                                                    <label>
                                                                                        <input type="checkbox" {{ ($respuesta->respuesta) ? 'checked' : '' }} name="respuestas[]" value="{{$respuesta->pregunta->clave_pregunta}}"/>
                                                                                        <span></span>
                                                                                        </label>
                                                                                    </span>
                                                                                </td>
