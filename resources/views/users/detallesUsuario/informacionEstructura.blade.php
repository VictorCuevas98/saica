			...
			<div class="card-header">
			 ...
			 <div class="card-body">
			 	...
			 	<div class="form-group row">
			 		<div class="col-xs-1"></div>
			 		<div class="col-md-10">
			 			<a href="{{ route('users.showInformacionPersona',$usuario->id) }}" class="navi-link py-4">
			 				<span>
					...
					<table class="table table-bordered table-striped">
                        <tbody>
                            <tr>
								...
								@if($puestoPersona->puesto_funcional->tipoContratacion->clave_tipo_contratacion=='E' && $puestoPersona->activo == true )

                                	<td>
                                        {{$puestoPersona->puesto_funcional->puestoEstructura->unidadAdministrativa->ente_publico->ente_publico}}
                                	</td>
	                                <td>
	                                	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cambioAdscripcionEstructura" title="Editar">
	                    					<span class="far fa-list-alt"></span>
	                    				</button>
	                    				@include('users._cambioAdscripcionEstrcutura_modal',['entesPublicos'=>$entesPublicos,'catTipoContratacion'=>$catTipoContratacion])
	                                </td>
	                            @else
...
<script type="text/javascript">
    ...
    var urlconsultaUnidades = "{{route('consulta.unidades')}}";
    var urlconsultaPuestos = "{{route('buscar_puestos')}}";
    var urlcamAdsEst = "{{route('users.cambioAdscripcionEstructura',$usuario->id)}}"


 </script>

<script type="text/javascript" src="{{ asset('js/admin/usuarios/cambioAdscripcionEstructura.js')}}">
</script>
