				...
				<div class="">
					...
					<table class="table table-bordered table-striped">
                        <tbody>
                                ...
                                <td>
                                    <div class="col-9">
                                         ...
                                         <div class="form-group row">
                                        	<div class="col-lg-10">
                                        	 	@php
                                        	 		$pna = $puestoPersona->puesto_funcional->puestoNoEstructura->puestosNoEstructuraAdscripcion()->where('activo',true)->get();
                                        	 		$entep = $pna->first()->unidadesAdministrativas->ente_publico->ente_publico; 
                                        	 	@endphp
                                        	 		{{$entep}}
                                        	</div>
                                        	<div class="col-lg-2">
    											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cambioAdscripcion" title="Editar">
                    								<span class="far fa-list-alt"></span>
                    							</button>
                    							@include('users._cambioAdscripcion_modal',['entesPublicos'=>$entesPublicos])
                                        	</div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>Fecha de adscripción:</td>
                                <td>
                                    <div class="col-9">
                                    	@php
                                        	$pna = $puestoPersona->puesto_funcional->puestoNoEstructura->puestosNoEstructuraAdscripcion()->where('activo',true)->get();
                                        	$fechaAdscripcion = $pna[0]->fecha_adscripcion;
                                        @endphp
...
<script type="text/javascript">
    ...
    var urlcamAdsNoEst = "{{route('users.cambioAdscripcionNoEstructura',$usuario->id)}}";

 </script>

<script type="text/javascript" src="{{ asset('js/admin/usuarios/cambioAdscripcionNoEstructura.js')}}">
</script>
