...
<div class="row">
			...
			<div class="card-header">
                <div class="card-toolbar">
                    <div class="float-left">
                         <h4 class="card-title">Catálogo Almacenes</h4>
                    </div>
                </div>
            </div>
	...
	<input type="hidden" name="url" id="url" value="{{url('/almacenes')}}">
	{{-- Scripts --}}
	@section('scripts')
    ...
    <script src="{{ URL::asset('js/catalogos/buscarColonia.js') }}" type="text/javascript"></script>
