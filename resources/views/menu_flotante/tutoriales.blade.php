...
<div class="card position-relative overflow-hidden mb-8">
   <div class="position-absolute bottom-0 left-0 right-0 d-none d-lg-flex flex-row-fluid">
      <span class="svg-icon svg-icon-full flex-row-fluid svg-icon-dark opacity-3">
         <!--begin::Svg Icon | path:../../../../../../../../metronic/themes/metronic/theme/html/demo1/dist/assets/media/bg/home-2-bg.svg-->
   ...
   <div class="position-absolute d-flex top-0 right-0 offset-lg-6 col-lg-6 opacity-30 opacity-lg-100">
      <span class="svg-icon svg-icon-full flex-row-fluid p-10">
         <!--begin::Svg Icon | path:../../../../../../../../metronic/themes/metronic/theme/html/demo1/dist/assets/media/svg/illustrations/working.svg-->
   ...
   <div class="card-body">
      <div class="col-lg-6">
         <div class="d-flex align-items-center flex-wrap py-40 px-5">
            <h2 class="text-dark font-weight-bolder mr-12">VIDEO TUTORIALES</h2>
         </div>
      </div>
   </div>
</div>
<!-- INICIO: VIDEOS REPRESENTANTE -->
@hasrole('SERVIDORPUBLICO')
<div class="row">

</div>

@endhasrole
<!-- FIN: VIDEOS REPRESENTANTE -->

<!-- INICIO: VIDEOS CORRESPONSAL -->
@hasrole('CORRESPONSABLE')
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card mb-8">
      <div class="card-body">
        <div class="p-6">
          <h2 class="text-dark mb-8">VIDEOS PARA CORRESPONSABLE</h2>
          <video width="100%" height="500" controls>
              <source src="" type="video/mp4">
              <source src="movie.ogg" type="video/ogg">
              Tu navegador no soporta este formato .mp4.
          </video>
        </div>
      </div>
    </div>
...
@endhasrole
<!-- FIN: VIDEOS CORRESPONSAL -->

<!-- INICIO: VIDEOS ENTE -->
@hasanyrole('SEDUVI|SAF|SEDEMA|SACMEX|SERVIMET')
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card mb-8">
      <div class="card-body">
        <div class="p-6">
          <h2 class="text-dark mb-8">VIDEOS PARA ENTE</h2>
          <video width="100%" height="500" controls>
              <source src="" type="video/mp4">
              <source src="movie.ogg" type="video/ogg">
              Tu navegador no soporta este formato .mp4.
...
<!-- INICIO: VIDEOS ADMIN ENTE -->
@hasanyrole('ADMINSEDUVI|ADMINSAF|ADMINSEDEMA|ADMINSACMEX|ADMINSERVIMET')
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card mb-8">
      <div class="card-body">
        <div class="p-6">
          <h2 class="text-dark mb-8">VIDEOS PARA ADMIN ENTE</h2>
          <video width="100%" height="500" controls>
              <source src="" type="video/mp4">
              <source src="movie.ogg" type="video/ogg">
              Tu navegador no soporta este formato .mp4.
...
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card mb-8">
      <div class="card-body">
        <div class="p-6">
          <h2 class="text-dark mb-8">VIDEOS PARA ADMIN</h2>
          <video width="100%" height="500" controls>
              <source src="" type="video/mp4">
              <source src="movie.ogg" type="video/ogg">
              Tu navegador no soporta este formato .mp4.
