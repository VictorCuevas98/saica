...
<script src="{{ URL::asset('assets/js/util.js')}}" type="text/javascript"></script>
...
<script src="{{ URL::asset('assets/vendors/general/jquery-validation/dist/additional-methods.min.js')}}" type="text/javascript"></script>
